...
describe('ListItemComponent', () => {
  ...
  describe('test @Input and @Output', () => {
    ...
    it('should contain appropriate title in h3 tag', () => {
      const h3Element = fixture.debugElement.query(By.css('.item-title'));
    ...
    it('should contain appropriate description in p tag', () => {
      const pElement = fixture.debugElement.query(By.css('.item-description'));
    ...
    it('should display mat-icon if importanceFlag === true', () => {
      ...
      fixture.detectChanges();
      const iconElement = fixture.debugElement.queryAll(By.css('.importance-flag'));
    ...
    it('should trigger click event on "Edit" button', () => {
      const buttonElement = fixture.debugElement.query(By.css('.edit-btn'));
      buttonElement.triggerEventHandler('click', null);
      expect(testComponent.editItem).toEqual(testComponent.updatedItem);
    });

    it('should trigger click event on "Delete" button', () => {
      const buttonElement = fixture.debugElement.query(By.css('.remove-btn'));
      buttonElement.triggerEventHandler('click', null);
